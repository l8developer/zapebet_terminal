...
//             InputStream caInput = context.getResources().openRawResource(R.raw.artizvc);
////             Certificate ca = cf.generateCertificate(caFileInputStream);
////             InputStream caInput = new BufferedInputStream(new FileInputStream("maquininha-MVP/app/src/main/res/layouts/activities/raw/artizvc.crt"));
//             Certificate ca;
//             try {
